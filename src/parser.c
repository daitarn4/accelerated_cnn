...
convolutional_layer parse_convolutional(list *options, size_params params)
{
    ...
    int fpga_load = option_find_int_quiet(options, "fpga_load", 0);
    printf("fpgaload = %d\n",fpga_load);
    printf("binary  = %d\n",binary );
    int fpga_save = option_find_int_quiet(options, "fpga_save", 0);
...
layer parse_yolo(list *options, size_params params)
{
    ...
    l.cpu_only = option_find_int_quiet(options, "cpu_only", 0);
