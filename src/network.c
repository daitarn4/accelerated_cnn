...
int resize_network(network *net, int w, int h)
{
    ...
    for (i = 0; i < net->n; ++i){
        ...
        if(l.workspace_size > 8000000000) 
	{
...
//printf("base.scales = %x : l.scales_gpu= %x\n ",base.scales,l.scales_gpu);
        if (base.scales && l.scales_gpu) cuda_push_array(l.scales_gpu, base.scales, l.n);
    } else if (l.type == CONNECTED) {
