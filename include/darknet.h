...
typedef enum{
    LOGISTIC, RELU, RELIE, LINEAR, RAMP, TANH, PLSE, LEAKY, BINARY, ELU, LOGGY, STAIR, HARDTAN, LHTAN
} ACTIVATION;
...
struct layer{
    ...
    cl_mem fpga_outbuf;
    // Convolution
    cl_mem fpga_coeffbuf;
    cl_mem fpga_binaryscalebuf;
    cl_mem fpga_div_sqrt_variance_buf;
    cl_mem fpga_rolling_mean_buf;
    cl_mem fpga_scales_buf;
    cl_mem fpga_biases_buf;
#endif
};
